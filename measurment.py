...
def mutual_info(vol1,vol2,bin):
  ...
  return np.sum(pxy[nzs] * np.log(pxy[nzs] / px_py[nzs])/np.log(2))
...
if __name__=='__main__':
      moving1='/home/n9614885/patchvm_data/25%/test/001_nuclear.nii.gz'
      moving2='/home/n9614885/patchvm_data/25%/test/002_nuclear.nii.gz'
      ref='/home/n9614885/CUBIC_Data/25%_registration/25%_data/003_nuclear.nii.gz'

      c1,m1=measurment(moving1,ref)
      print ("CC:"+str(c1)+" MI:"+str(m1))
      c2,m2=measurment(moving2,ref)
      print ("CC:"+str(c2)+" MI:"+str(m2))
